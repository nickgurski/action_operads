...
\item 4.1.3/7.1.2 check 2.3.10: need to make sure this is in an earlier section, and ref'ed (actually seems to rely on the lemma previous to the one referenced: `G0abel' (AC is stuck on this), not `calclem')
