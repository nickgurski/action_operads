...
Section 3:
1. Defn of monad map: should we put these in as pasting diagrams instead? Also, missing diagram for transformations - added but same question about pasting diagrams instead.
...
6.4: should this be combined with 3.2? [NG: redo after seeing Nicola's talk]
