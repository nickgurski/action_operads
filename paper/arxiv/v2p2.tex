...
The operadic crossed simplicial groups of Semidetnov appear to correspond to action operads with trivial $\Lambda_0$, although they are defined using $\circ_i$ operations instead of an operadic composition $\mu$. Continuing the comparison, his $G_\ast$-shifted operads \cite[Definition 3.5]{semidetnov} satisfy two axioms that are the same as those for $\Lambda$-operads in \Cref{Defi:lamop}. 
\end{rem}
