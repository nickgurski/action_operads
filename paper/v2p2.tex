...
The operadic crossed simplicial groups of Semidetnov appear to correspond to action operads with trivial $\Lambda_0$ and his $G_\ast$-shifted operads \cite[Definition 3.5]{semidetnov} satisfy two axioms which are the same as those for $\Lambda$-operads in \Cref{Defi:lamop}. While the operads of Semidetnov are defined using circle-$i$ notation, the correspondence seems quite clear.\acnote{reword more better}
\end{rem}
