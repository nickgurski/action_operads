...
Surjective: Suppose that $\pi_2 \colon \Lambda(2) \rightarrow \Sigma_2$ is surjective, then there exists $g \in \Lambda(2)$ such that $\pi_2(g) = \trans{1}{2}$. Considering a transposition $\trans{a}{a+1} \in \Sigma_n$, for $n > 2$, we see that
  \begin{align*}
  ...
  \end{align*}
Since this is the image of an element in $\Lambda(n)$ and $\Sigma_n$ is generated by the adjacent transpositions, then $\pi_n$ is surjective.

In this argument we have used Axiom 1 of \ref{thm:charAOp} and where the underlined elements $\underline{e_1}$ consist of $n-a$ copies of $e_1$ to the left of $g$ and $n-a-1$ copies of $e_1$ to the right. Hence, if $\pi_2$ is surjective, then so is $\pi_n$ for any $n > 2$.
Zero: 
