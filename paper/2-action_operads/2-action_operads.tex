...
evaluated on the element $\left( (123); (12), (12)(34), (13) \right)$.
  \begin{center}
  \begin{tikzpicture}
  \draw (1,0) -- (2,-1) -- (6.11,-2.5);
  \draw (2,0) -- (1,-1) -- (4.888,-2.5);
  \draw (4,0) -- (5,-1) -- (8.554,-2.5);
  \draw (5,0) -- (4,-1) -- (7.332,-2.5);
  \draw (6,0) -- (7,-1) -- (10.998,-2.5);
  \draw (7,0) -- (6,-1) -- (9.776,-2.5);
  \draw (9,0) -- (11,-1) -- (3.666,-2.5);
  \draw (10,0) -- (10,-1) -- (2.444,-2.5);
  \draw(11,0) -- (9,-1) -- (1.222,-2.5);
  \end{tikzpicture}
  \end{center}
  % \[
  %   \xy
...
\item QQQ Improve Diagrams. The final axiom is best explained using the operad $\Sigma$ of symmetric groups. Reading symmetric group elements as permutations from top to bottom, below is a pictorial representation of the final axiom for the map $\mu \colon \Sigma_{3} \times \Sigma_{2} \times \Sigma_{2} \times \Sigma_{2} \rightarrow \Sigma_{6}.$
  \[
    \xy
      {\ar@{-} (0,0)*{}; (5,-5)*{} };
      {\ar@{-} (5,-5)*{}; (29,-10)*{} };
...
Now that $B\Lambda$ has a monoidal structure, there is also a monoidal structure on the category of $B\Lambda$-collections
  \[
    [B\Lambda^{\textrm{op}}, \mb{Sets}] = \hat{B\Lambda}
  \]
...
Let $\Lambda$ be an action operad, let $Y \in \hat{B\Lambda}$, and let $k$ be a fixed natural number. Then the assignment
  \[
    n \mapsto Y^{\star n}(k)
  \]
