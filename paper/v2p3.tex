...
For our purposes, we are interested in braids which are both positive and minimal. A proof of the following lemma can be found in \cite[Theorem 2.6]{EM2} \cite{EM2} \ngnote{specific ref}\acnote{correct ref?}.
