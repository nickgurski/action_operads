...
\item 1-cell identities $1_M \colon M \to M$ given by the identity functor equipped with\ngnote{fill in},
and
\item the underlying functor of the composite 1-cell given by
\end{itemize}
\end{prop}
\begin{proof}
\ngnoteil{fill in}
