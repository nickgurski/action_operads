...
Since we will be computing with coequalizers of the form $\coeqb{A}{B}{\Lambda}$ repeatedly, we give the following useful lemma.
...
The $2$-monad $\underline{E\Lambda}$ has underlying 2-functor given by
  ...
  \]
We will eventually show that $\Lambda$-monoidal categories can be given in more familiar terms as in Chapter 19 of \cite{yau_infinity_2021}, but first we compute the hom-sets of the free algebras $\EL(X)$.
