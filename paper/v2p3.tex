...
\end{thm}
\begin{proof}
To give the functor $B\pi \colon B\Lambda \rightarrow B \Sigma$ the structure of a club it suffices (see\ngnote{find specific thm number}\acnote{I'm sure this is essentially the stuff in Appendix C, but I can't pick out exactly where} \cite{leinster}) to show that
\begin{itemize}
