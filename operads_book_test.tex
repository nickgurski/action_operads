...
\[ \mathrm{Mor}(L_n) \quad \cong \quad (s \times t)(L_n) \times L_n(I,I) \]
we only need to compute its projection onto $L_n(I,I)$. By QQQ ref, $q: \ELnn \to L_n$ is a surjective map of $E\Lambda$-algebras, so 
\[
