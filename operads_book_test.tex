...
We will now exploit the surjectivity of the algebra map $q: \ELnn \to L_n$ as discussed in \cref{actmorLGn} in order to determine the $\ML$-monoidal structure on $L_n$.
