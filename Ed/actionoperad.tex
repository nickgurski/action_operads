...
\begin{eq*} l_{f} \, : \, 1_y \circ f \longrightarrow f, \quad \quad \quad \quad r_{f} \, : \, f \otimes 1_x \longrightarrow f \end{eq*}
\end{itemize}
...
\begin{eq*} \begin{array}{rlrll}
		\mathrm{E}f & : & \mathrm{E}S & \to & \mathrm{E}S' \\
		& : & s & \mapsto & f(s) \\
