...
We end this section by presenting some results which allow us to transfer operad or algebra structures to other categories. We will use the following standard definitions, as per \cite{street-formal}.
...
QQQ Definition already used in Section 2. Needs moving.
