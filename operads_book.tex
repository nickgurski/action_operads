...
QQQ Possibly reword the following given the remark about limits.
\begin{proof}
...
QQQ Inconsistencies around using $\ML$ and $\Lambda$. $\ML$ is the action operad and $\Lambda$ is the underlying operad with nothing else.QQQ
...
QQQ Repetition of action operad definition. QQQ
...
\begin{rem}
QQQ $\ML$-actions, $\ML$-equivariance... Or $\Lambda$-actions, etc.? QQQ
