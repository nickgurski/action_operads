...
\section{Coequalizers of $\ML$-monoidal categories}
QQQ Need to define what we mean by $\ML$-monoidal categories. QQQ
...
For an monad $T$ on a category $C$, the forgetful functor $T\Alg \to C$ creates any colimit that $T$ preserves. This fact and the previous lemmas prove the following proposition using the operad $P = E\Lambda$.
