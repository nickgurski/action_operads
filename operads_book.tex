...
Let $X,Y$ be strict $\ML$-monoidal categories, and $F \colon X \rightarrow Y$ be a functor. $F$ is a strict $\ML$-monoidal functor if and only if something.
\end{prop}
\begin{proof}
